...
#pragma endregion
	...
	void Scene_W3_CookTorrance::Initialize()
	{
		m_Camera.origin = { 0.f, 1.f, -5.f };
		m_Camera.fovAngle = 45.f;

		const auto matCT_GrayRoughMetal = AddMaterial(new Material_CookTorrence({ .972f,.960f,.915f }, 1.f, 1.0f));
		...
		const auto matCT_GrayRoughPlastic = AddMaterial(new Material_CookTorrence({ .75f,.75f,.75f }, 0.f, 1.0f));
		...
		const auto matLamberPhong1 = AddMaterial(new Material_LambertPhong(colors::Blue, .5f, .5f, 3.f));
		const auto matLamberPhong2 = AddMaterial(new Material_LambertPhong(colors::Blue, .5f, .5f, 15.f));
		const auto matLamberPhong3 = AddMaterial(new Material_LambertPhong(colors::Blue, .5f, .5f, 50.f));
		...
		AddSphere(Vector3{ -1.75f,1.0f,0.f }, .75f, matCT_GrayRoughMetal);
		AddSphere(Vector3{ 0.f,1.0f,0.f }, .75f, matCT_GrayMediumMetal);
		AddSphere(Vector3{ 1.75f,1.0f,0.f }, .75f, matCT_GraySmoothMetal);
		AddSphere(Vector3{ -1.75f,3.0f,0.f }, .75f, matCT_GrayRoughPlastic);
		AddSphere(Vector3{ 0.f,3.0f,0.f }, .75f, matCT_GrayMediumPlastic);
		AddSphere(Vector3{ 1.75f,3.0f,0.f }, .75f, matCT_GraySmoothPlastic);


		AddPointLight(Vector3{ 0.f,5.0f,5.0f }, 50.f, ColorRGB{ 1.0f,.61f,.45f });
		AddPointLight(Vector3{ -2.5f,5.0f,-5.0f }, 70.f, ColorRGB{ 1.0f,.8f,.45f });
		AddPointLight(Vector3{ 2.5f,2.5f,-5.0f }, 50.f, ColorRGB{ .34f,.47f,.68f });
	}
}
